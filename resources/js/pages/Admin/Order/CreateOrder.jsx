...
function CreateOrder() {
    ...
    const getUserPoints = async (data) => {
        const points = data;
                                        ...
                                        <div class="products-search-box cart-box ">
                                            ...
                                            <div class="cart-details">
                                                ...
                                                <div class="select-user-box">
                                                    ...
                                                    <select name="users" id="users" onChange={(e) => getUserPoints(e.target.selectedOptions[0].dataset.points)}>
                                                    ...
                                                    <div class="select-user-box pricing-details">
                                                      ...
                                                      <div class="three-input-boxes">
                                                        <input type="text"  placeholder="Guest Order" />
                                                        <input type="text"  placeholder="Guest Order" />
                                                        <input type="text"  placeholder="Guest Order" />
                                                      </div>
                                                    </div>
